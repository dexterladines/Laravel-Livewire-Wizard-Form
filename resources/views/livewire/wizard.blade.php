    ...
    <div class="col-xs-12">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <label for="radio-inline"><input type="radio" wire:model="status" value="1" {{{  $status == '1' ? "checked" : "" }}}>Active</label>
                <label for="radio-inline"><input type="radio" wire:model="status" value="0" {{ $status == '0' ? "checked" : "" }}>Deactivate</label>
                @error('status')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><strong>{{ $status ? 'Active' : 'DeActivate' }}</strong></td>
                </tr>
                <tr>
